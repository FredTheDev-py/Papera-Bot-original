...
class Unlock(commands.Cog):
    ...
    @commands.command(aliases=["unlock"], name="Unlock", description="apre tutte le stanze del server", usage="{prefix}unlock")
    @commands.has_any_role('Generale', 'Senato Imperiale', 'Imperatori')
    async def unlock(self, ctx):
        embed = discord.Embed(title="Comando eseguito con sucesso!", description="**Server aperto!**",colour=discord.Color.green())
